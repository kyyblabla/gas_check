...
void MainForm::createActions(){
    ...
    settingAction=new QAction(QStringLiteral("设置"),this);
    connect(settingAction,SIGNAL(triggered()),this,SLOT(doSetting()));

    //showLogView
    logViewAction=new QAction(QStringLiteral("日志"),this);
